...
namespace ECARTemplate.Controllers
{
    ...
    public class EquiposController : Controller
    {
        ...
        // GET: Equipos/Index
        [Authorize(Roles = "Admin,Estandar")]
        ...
        [Authorize(Roles = "Admin")]
        public async Task<IActionResult> Create([Bind("Id,CodigoEquipo,Fecha,NombreEquipo,Sede,Area,SubArea,Nota,Estado,UsuarioTiRegistro,RutaImagen,HojaDeVida")] Equipo equipo, IFormFile imageFile)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Admin")]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CodigoEquipo,Fecha,NombreEquipo,Sede,Area,SubArea,Nota,Estado,UsuarioTiRegistro,RutaImagen,HojaDeVida")] Equipo equipo, IFormFile imageFile)
        {
